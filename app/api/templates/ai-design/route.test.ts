...
vi.mock("@/lib/db", () => ({
  ...
  schema: {
    projects: { id: "id", userId: "userId", data: "data", userBrief: "userBrief", updatedAt: "updatedAt" },
  },
}));
  ...
  beforeEach(() => {
    ...
    mocks.select.mockReturnValue({
      from: () => ({
        where: () => ({
          limit: async () => [
            { data: { html: CURRENT_HTML }, userBrief: "", updatedAt: new Date("2026-09-14T10:00:00Z"), id: "p1" },
          ],
        }),
      }),
    });
