...
// Official brand glyph (not a generic Lucide shape) — same path as the
// published-page WhatsApp FAB (lib/publish/whatsapp-button.ts) so the icon
// reads identically wherever WhatsApp appears in the product.
