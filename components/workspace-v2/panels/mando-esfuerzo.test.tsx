...
describe("el mando de esfuerzo tiene la forma del binario", () => {
  ...
  // 🔴 LA REGLA DE ESTE MANDO. El binario imprime `Effort level: auto
  ...
  // las del binario. La clave `*Desc` es la que lo lleva.
