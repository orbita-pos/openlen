...
function AIDesignChat({
  ...
  // del cliente. Hasta que conteste se arranca con la RESERVA DEL BINARIO
        ...
        try {
          ...
          const res = await fetch("/api/agent", {
            ...
            body: JSON.stringify({
              ...
              // perfil en el servidor, que es lo que hace el binario con
...
function Composer({
   ...
   *  y por eso se pinta aparte y AL FINAL, igual que en el binario de Claude
   *  Code (`Tm` lleva los cinco niveles; `auto` se añade suelto). */
  esfuerzo?: EsfuerzoAgente;
  /** A qué nivel resuelve `auto`, para poder DECIRLO. El binario nunca deja al
...
${t("composer.goalSince", {
  ...
  return (
    <div className="shrink-0 px-3 pb-3">
      ...
      {/* LA PUERTA DEL DUEÑO. El binario deja dicho cuál es la invariante:
      ...
      {objetivo && (
        <div className="mb-1.5 inline-flex items-center gap-1.5 max-w-full rounded-md ring-1 ring-[color:var(--accent)]/40 bg-accent-soft px-2 py-1 text-[11px] text-accent ui-small fade-in">
          ...
          <button
            ...
            // que hace el binario: su `/goal` es `immediate: true` y su hook de
          ...
          <div className="flex items-center gap-0.5">
            ...
            {onPonerObjetivo && (
              <button
                ...
                // hace el binario: «a newly approved or directly set proposal
