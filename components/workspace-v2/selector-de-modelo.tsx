...
//
// LA FORMA ES LA DEL `ModelPicker` DEL BINARIO de Claude Code, leído en 2.1.257
...
//  - LA PRIMERA FILA ES SIEMPRE EL DEFECTO. Es su `Gie()`: valor `null`, label
//    «Default (recommended)», descripción «Use the default model (currently X)».
...
//    allí: «Best for everyday, complex tasks», «Fastest for quick answers».
//  - LAS FILAS DESHABILITADAS LLEVAN EL MOTIVO DENTRO, en el sitio de la
//    descripción (`{...j, disabled:!0, description: motivo}`), y se hunden al
//    fondo de la lista. Aquí sólo hay un motivo: el razonador no tiene ojos.
//
// 🔴 SIN PRECIO POR FILA, y no es un olvido. El binario pinta
            ...
            return (
              ...
              >
                ...
                {/* El motivo OCUPA el sitio de la descripción, no se añade
                    debajo: es la forma del binario, y evita una fila de dos
