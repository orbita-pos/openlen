...
//     hay una imagen. Es la forma del `ModelPicker` del binario, cuyas filas
...
describe("lo que enseña", () => {
  ...
  // de la descripción, que es como lo hace el binario.
...
describe("cómo se sale", () => {
  ...
  // eligiendo o volviendo a pulsar el botón. El binario tiene
