...
// sitios.
//
// LO QUE DICE EL BINARIO. Su contexto `Select` declara, literal:
//
//   {context:"Select", bindings:{ up:"select:previous", down:"select:next",
//     j:"select:next", k:"select:previous", "ctrl+n":…, "ctrl+p":…,
//     pageup:"select:pageUp", pagedown:"select:pageDown",
//     home:"select:first", end:"select:last",
...
// navegador sobre un `<button>`. Y en 2.1.266 su selector pasó a llevar
// `tabIndex:0, autoFocus:!0` en la raíz, o sea que al abrirse **mete el foco
...
//     seis opciones.
//
// 🔴 EL CLIC FUERA NO SALE DEL BINARIO — no tiene ratón, así que no puede
...
export function useMandoDesplegable({
  ...
  // primera. Es el `autoFocus:!0` que su selector estrenó en 2.1.266, y sin esto
