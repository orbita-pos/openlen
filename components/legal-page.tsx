    ...
    <main className="mx-auto max-w-2xl px-5 py-16 sm:py-24">
      ...
      >
        ...
        <span className="font-semibold tracking-tight text-[15px]">
          Open<span className="text-[#FF5A36]">Len</span>
        </span>
      </Link>
      ...
      {updated && (
        <p className="text-[13px] text-zinc-500 mb-8">{updated}</p>
      )}
      <div className="space-y-4 text-[15px] leading-relaxed text-zinc-700 dark:text-zinc-300 [&_h2]:text-zinc-900 dark:[&_h2]:text-zinc-100 [&_h2]:font-semibold [&_h2]:text-[17px] [&_h2]:mt-8 [&_h2]:mb-1 [&_a]:text-[#FF5A36] [&_a]:underline [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1 [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:space-y-1">
        {children}
      </div>
    </main>
  );
