    ...
    async start(controller) {
      ...
      try {
        ...
        try {
          ...
          // The draft id is generated by this request and has never been
          // exposed. Compensate it before emitting the redacted failure.
        ...
        // Flush redacted Fable accounting only after the durable project and
        // debit commit. A telemetry sink failure is intentionally non-fatal.
