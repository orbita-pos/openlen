...
const GATE = "vitest run lib/curate/generate-page-copy.test.ts lib/curate/finalize-composed-document.test.ts lib/curate/quick-section-composition.test.ts lib/curate/ai-composition-delivery.test.ts lib/curate/quick-visual-repair.test.ts lib/curate/run-ai-creation.test.ts lib/curate/ai-creation-mode.test.ts lib/curate/ai-creation-rollout.test.ts lib/curate/ai-creation-credits.test.ts lib/curate/commit-ai-composition.test.ts lib/curate/curate-route.integration.test.ts lib/generation/section-variant-semantics.test.ts lib/generation/deterministic-creative-direction.test.ts lib/generation/compose-sections.test.ts lib/generation/section-inventory.test.ts lib/generation/visual-engine-2b-qualification.test.ts lib/generation/ai-hybrid-niche-cohort.test.ts lib/curate/ai-hybrid-import-boundary.test.ts lib/curate/ai-hybrid-regression.test.ts lib/curate/explicit-template-clone-contract.test.ts lib/curate/ai-hybrid-runbook-contract.test.ts";
