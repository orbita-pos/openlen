// De qué rubro habla un brief. Es una tabla de palabras clave, sin red y sin
// base de datos — vive aparte porque el sembrado de fotos lo necesita y no
// tiene por qué arrastrar el almacén de plantillas con él: la puerta de
// generación no debe poder alcanzar una plantilla ni por accidente.
