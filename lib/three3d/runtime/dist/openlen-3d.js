...
`)+`
`+f);let v=x+m+a,_=x+f+o,R=Wu(i,i.VERTEX_SHADER,v),T=Wu(i,i.FRAGMENT_SHADER,_);i.attachShader(b,R),i.attachShader(b,T),t.index0AttributeName!==void 0?i.bindAttribLocation(b,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(b,0,"position"),i.linkProgram(b);function E(P){if(s.debug.checkShaderErrors){let z=i.getProgramInfoLog(b).trim(),k=i.getShaderInfoLog(R).trim(),X=i.getShaderInfoLog(T).trim(),W=!0,G=!0;if(i.getProgramParameter(b,i.LINK_STATUS)===!1)if(W=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,b,R,T);else{let J=qu(i,R,"vertex"),H=qu(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(b,i.VALIDATE_STATUS)+`
...
}`;function Wb(s,e,t){let n=new cs,i=new te,r=new te,a=new je,o=new wa({depthPacking:mu}),c=new Ea,l={},h=t.maxTextureSize,u={[pn]:Et,[Et]:pn,[tn]:tn},d=new ft({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new te},radius:{value:4}},vertexShader:Hb,fragmentShader:Vb}),p=d.clone();p.defines.HORIZONTAL_PASS=1;let g=new dt;g.setAttribute("position",new ut(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let b=new Oe(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ic;let f=this.type;this.render=function(T,E,I){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;let A=s.getRenderTarget(),y=s.getActiveCubeFace(),P=s.getActiveMipmapLevel(),z=s.state;z.setBlending(gn),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);let k=f!==En&&this.type===En,X=f===En&&this.type!==En;for(let W=0,G=T.length;W<G;W++){let J=T[W],H=J.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;i.copy(H.mapSize);let ie=H.getFrameExtents();if(i.multiply(ie),r.copy(H.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/ie.x),i.x=r.x*ie.x,H.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/ie.y),i.y=r.y*ie.y,H.mapSize.y=r.y)),H.map===null||k===!0||X===!0){let xe=this.type!==En?{minFilter:At,magFilter:At}:{};H.map!==null&&H.map.dispose(),H.map=new It(i.x,i.y,xe),H.map.texture.name=J.name+".shadowMap",H.camera.updateProjectionMatrix()}s.setRenderTarget(H.map),s.clear();let ue=H.getViewportCount();for(let xe=0;xe<ue;xe++){let Le=H.getViewport(xe);a.set(r.x*Le.x,r.y*Le.y,r.x*Le.z,r.y*Le.w),z.viewport(a),H.updateMatrices(J,xe),n=H.getFrustum(),_(E,I,H.camera,J,this.type)}H.isPointLightShadow!==!0&&this.type===En&&x(H,I),H.needsUpdate=!1}f=this.type,m.needsUpdate=!1,s.setRenderTarget(A,y,P)};function x(T,E){let I=e.update(b);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new It(i.x,i.y)),d.uniforms.shadow_pass.value=T.map.texture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,s.setRenderTarget(T.mapPass),s.clear(),s.renderBufferDirect(E,null,I,d,b,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,s.setRenderTarget(T.map),s.clear(),s.renderBufferDirect(E,null,I,p,b,null)}function v(T,E,I,A){let y=null,P=I.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)y=P;else if(y=I.isPointLight===!0?c:o,s.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0){let z=y.uuid,k=E.uuid,X=l[z];X===void 0&&(X={},l[z]=X);let W=X[k];W===void 0&&(W=y.clone(),X[k]=W,E.addEventListener("dispose",R)),y=W}if(y.visible=E.visible,y.wireframe=E.wireframe,A===En?y.side=E.shadowSide!==null?E.shadowSide:E.side:y.side=E.shadowSide!==null?E.shadowSide:u[E.side],y.alphaMap=E.alphaMap,y.alphaTest=E.alphaTest,y.map=E.map,y.clipShadows=E.clipShadows,y.clippingPlanes=E.clippingPlanes,y.clipIntersection=E.clipIntersection,y.displacementMap=E.displacementMap,y.displacementScale=E.displacementScale,y.displacementBias=E.displacementBias,y.wireframeLinewidth=E.wireframeLinewidth,y.linewidth=E.linewidth,I.isPointLight===!0&&y.isMeshDistanceMaterial===!0){let z=s.properties.get(y);z.light=I}return y}function _(T,E,I,A,y){if(T.visible===!1)return;if(T.layers.test(E.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&y===En)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,T.matrixWorld);let k=e.update(T),X=T.material;if(Array.isArray(X)){let W=k.groups;for(let G=0,J=W.length;G<J;G++){let H=W[G],ie=X[H.materialIndex];if(ie&&ie.visible){let ue=v(T,ie,A,y);T.onBeforeShadow(s,T,E,I,k,ue,H),s.renderBufferDirect(I,null,k,ue,T,H),T.onAfterShadow(s,T,E,I,k,ue,H)}}}else if(X.visible){let W=v(T,X,A,y);T.onBeforeShadow(s,T,E,I,k,W,null),s.renderBufferDirect(I,null,k,W,T,null),T.onAfterShadow(s,T,E,I,k,W,null)}}let z=T.children;for(let k=0,X=z.length;k<X;k++)_(z[k],E,I,A,y)}function R(T){T.target.removeEventListener("dispose",R);for(let I in l){let A=l[I],y=T.target.uuid;y in A&&(A[y].dispose(),delete A[y])}}}var Xb={[Fa]:Na,[Oa]:za,[Ba]:Ga,[xi]:ka,[Na]:Fa,[za]:Oa,[Ga]:Ba,[ka]:xi};function qb(s,e){function t(){let D=!1,se=new je,V=null,K=new je(0,0,0,0);return{setMask:function(le){V!==le&&!D&&(s.colorMask(le,le,le,le),V=le)},setLocked:function(le){D=le},setClear:function(le,ce,De,lt,Rt){Rt===!0&&(le*=lt,ce*=lt,De*=lt),se.set(le,ce,De,lt),K.equals(se)===!1&&(s.clearColor(le,ce,De,lt),K.copy(se))},reset:function(){D=!1,V=null,K.set(-1,0,0,0)}}}function n(){let D=!1,se=!1,V=null,K=null,le=null;return{setReversed:function(ce){if(se!==ce){let De=e.get("EXT_clip_control");se?De.clipControlEXT(De.LOWER_LEFT_EXT,De.ZERO_TO_ONE_EXT):De.clipControlEXT(De.LOWER_LEFT_EXT,De.NEGATIVE_ONE_TO_ONE_EXT);let lt=le;le=null,this.setClear(lt)}se=ce},getReversed:function(){return se},setTest:function(ce){ce?ae(s.DEPTH_TEST):Te(s.DEPTH_TEST)},setMask:function(ce){V!==ce&&!D&&(s.depthMask(ce),V=ce)},setFunc:function(ce){if(se&&(ce=Xb[ce]),K!==ce){switch(ce){case Fa:s.depthFunc(s.NEVER);break;case Na:s.depthFunc(s.ALWAYS);break;case Oa:s.depthFunc(s.LESS);break;case xi:s.depthFunc(s.LEQUAL);break;case Ba:s.depthFunc(s.EQUAL);break;case ka:s.depthFunc(s.GEQUAL);break;case za:s.depthFunc(s.GREATER);break;case Ga:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}K=ce}},setLocked:function(ce){D=ce},setClear:function(ce){le!==ce&&(se&&(ce=1-ce),s.clearDepth(ce),le=ce)},reset:function(){D=!1,V=null,K=null,le=null,se=!1}}}function i(){let D=!1,se=null,V=null,K=null,le=null,ce=null,De=null,lt=null,Rt=null;return{setTest:function($e){D||($e?ae(s.STENCIL_TEST):Te(s.STENCIL_TEST))},setMask:function($e){se!==$e&&!D&&(s.stencilMask($e),se=$e)},setFunc:function($e,on,Pn){(V!==$e||K!==on||le!==Pn)&&(s.stencilFunc($e,on,Pn),V=$e,K=on,le=Pn)},setOp:function($e,on,Pn){(ce!==$e||De!==on||lt!==Pn)&&(s.stencilOp($e,on,Pn),ce=$e,De=on,lt=Pn)},setLocked:function($e){D=$e},setClear:function($e){Rt!==$e&&(s.clearStencil($e),Rt=$e)},reset:function(){D=!1,se=null,V=null,K=null,le=null,ce=null,De=null,lt=null,Rt=null}}}let r=new t,a=new n,o=new i,c=new WeakMap,l=new WeakMap,h={},u={},d=new WeakMap,p=[],g=null,b=!1,m=null,f=null,x=null,v=null,_=null,R=null,T=null,E=new he(0,0,0),I=0,A=!1,y=null,P=null,z=null,k=null,X=null,W=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS),G=!1,J=0,H=s.getParameter(s.VERSION);H.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(H)[1]),G=J>=1):H.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),G=J>=2);let ie=null,ue={},xe=s.getParameter(s.SCISSOR_BOX),Le=s.getParameter(s.VIEWPORT),tt=new je().fromArray(xe),Y=new je().fromArray(Le);function ee(D,se,V,K){let le=new Uint8Array(4),ce=s.createTexture();s.bindTexture(D,ce),s.texParameteri(D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(D,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let De=0;De<V;De++)D===s.TEXTURE_3D||D===s.TEXTURE_2D_ARRAY?s.texImage3D(se,0,s.RGBA,1,1,K,0,s.RGBA,s.UNSIGNED_BYTE,le):s.texImage2D(se+De,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,le);return ce}let be={};be[s.TEXTURE_2D]=ee(s.TEXTURE_2D,s.TEXTURE_2D,1),be[s.TEXTURE_CUBE_MAP]=ee(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),be[s.TEXTURE_2D_ARRAY]=ee(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),be[s.TEXTURE_3D]=ee(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ae(s.DEPTH_TEST),a.setFunc(xi),Ge(!1),He(Pc),ae(s.CULL_FACE),L(gn);function ae(D){h[D]!==!0&&(s.enable(D),h[D]=!0)}function Te(D){h[D]!==!1&&(s.disable(D),h[D]=!1)}function Pe(D,se){return u[D]!==se?(s.bindFramebuffer(D,se),u[D]=se,D===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=se),D===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=se),!0):!1}function ke(D,se){let V=p,K=!1;if(D){V=d.get(se),V===void 0&&(V=[],d.set(se,V));let le=D.textures;if(V.length!==le.length||V[0]!==s.COLOR_ATTACHMENT0){for(let ce=0,De=le.length;ce<De;ce++)V[ce]=s.COLOR_ATTACHMENT0+ce;V.length=le.length,K=!0}}else V[0]!==s.BACK&&(V[0]=s.BACK,K=!0);K&&s.drawBuffers(V)}function at(D){return g!==D?(s.useProgram(D),g=D,!0):!1}let We={[ni]:s.FUNC_ADD,[qh]:s.FUNC_SUBTRACT,[Yh]:s.FUNC_REVERSE_SUBTRACT};We[jh]=s.MIN,We[Kh]=s.MAX;let pt={[Jh]:s.ZERO,[Zh]:s.ONE,[Qh]:s.SRC_COLOR,[oa]:s.SRC_ALPHA,[su]:s.SRC_ALPHA_SATURATE,[nu]:s.DST_COLOR,[eu]:s.DST_ALPHA,[$h]:s.ONE_MINUS_SRC_COLOR,[ca]:s.ONE_MINUS_SRC_ALPHA,[iu]:s.ONE_MINUS_DST_COLOR,[tu]:s.ONE_MINUS_DST_ALPHA,[ru]:s.CONSTANT_COLOR,[au]:s.ONE_MINUS_CONSTANT_COLOR,[ou]:s.CONSTANT_ALPHA,[cu]:s.ONE_MINUS_CONSTANT_ALPHA};function L(D,se,V,K,le,ce,De,lt,Rt,$e){if(D===gn){b===!0&&(Te(s.BLEND),b=!1);return}if(b===!1&&(ae(s.BLEND),b=!0),D!==Xh){if(D!==m||$e!==A){if((f!==ni||_!==ni)&&(s.blendEquation(s.FUNC_ADD),f=ni,_=ni),$e)switch(D){case _i:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case br:s.blendFunc(s.ONE,s.ONE);break;case Lc:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Dc:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case _i:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case br:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case Lc:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Dc:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}x=null,v=null,R=null,T=null,E.set(0,0,0),I=0,m=D,A=$e}return}le=le||se,ce=ce||V,De=De||K,(se!==f||le!==_)&&(s.blendEquationSeparate(We[se],We[le]),f=se,_=le),(V!==x||K!==v||ce!==R||De!==T)&&(s.blendFuncSeparate(pt[V],pt[K],pt[ce],pt[De]),x=V,v=K,R=ce,T=De),(lt.equals(E)===!1||Rt!==I)&&(s.blendColor(lt.r,lt.g,lt.b,Rt),E.copy(lt),I=Rt),m=D,A=!1}function Kt(D,se){D.side===tn?Te(s.CULL_FACE):ae(s.CULL_FACE);let V=D.side===Et;se&&(V=!V),Ge(V),D.blending===_i&&D.transparent===!1?L(gn):L(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);let K=D.stencilWrite;o.setTest(K),K&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),st(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ae(s.SAMPLE_ALPHA_TO_COVERAGE):Te(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ge(D){y!==D&&(D?s.frontFace(s.CW):s.frontFace(s.CCW),y=D)}function He(D){D!==Hh?(ae(s.CULL_FACE),D!==P&&(D===Pc?s.cullFace(s.BACK):D===Vh?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Te(s.CULL_FACE),P=D}function ve(D){D!==z&&(G&&s.lineWidth(D),z=D)}function st(D,se,V){D?(ae(s.POLYGON_OFFSET_FILL),(k!==se||X!==V)&&(s.polygonOffset(se,V),k=se,X=V)):Te(s.POLYGON_OFFSET_FILL)}function ye(D){D?ae(s.SCISSOR_TEST):Te(s.SCISSOR_TEST)}function w(D){D===void 0&&(D=s.TEXTURE0+W-1),ie!==D&&(s.activeTexture(D),ie=D)}function M(D,se,V){V===void 0&&(ie===null?V=s.TEXTURE0+W-1:V=ie);let K=ue[V];K===void 0&&(K={type:void 0,texture:void 0},ue[V]=K),(K.type!==D||K.texture!==se)&&(ie!==V&&(s.activeTexture(V),ie=V),s.bindTexture(D,se||be[D]),K.type=D,K.texture=se)}function N(){let D=ue[ie];D!==void 0&&D.type!==void 0&&(s.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function j(){try{s.compressedTexImage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Z(){try{s.compressedTexImage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function q(){try{s.texSubImage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function _e(){try{s.texSubImage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function oe(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function fe(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Xe(){try{s.texStorage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function $(){try{s.texStorage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function pe(){try{s.texImage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ae(){try{s.texImage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function we(D){tt.equals(D)===!1&&(s.scissor(D.x,D.y,D.z,D.w),tt.copy(D))}function me(D){Y.equals(D)===!1&&(s.viewport(D.x,D.y,D.z,D.w),Y.copy(D))}function Ve(D,se){let V=l.get(se);V===void 0&&(V=new WeakMap,l.set(se,V));let K=V.get(D);K===void 0&&(K=s.getUniformBlockIndex(se,D.name),V.set(D,K))}function Ue(D,se){let K=l.get(se).get(D);c.get(se)!==K&&(s.uniformBlockBinding(se,K,D.__bindingPointIndex),c.set(se,K))}function it(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},ie=null,ue={},u={},d=new WeakMap,p=[],g=null,b=!1,m=null,f=null,x=null,v=null,_=null,R=null,T=null,E=new he(0,0,0),I=0,A=!1,y=null,P=null,z=null,k=null,X=null,tt.set(0,0,s.canvas.width,s.canvas.height),Y.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ae,disable:Te,bindFramebuffer:Pe,drawBuffers:ke,useProgram:at,setBlending:L,setMaterial:Kt,setFlipSided:Ge,setCullFace:He,setLineWidth:ve,setPolygonOffset:st,setScissorTest:ye,activeTexture:w,bindTexture:M,unbindTexture:N,compressedTexImage2D:j,compressedTexImage3D:Z,texImage2D:pe,texImage3D:Ae,updateUBOMapping:Ve,uniformBlockBinding:Ue,texStorage2D:Xe,texStorage3D:$,texSubImage2D:q,texSubImage3D:_e,compressedTexSubImage2D:oe,compressedTexSubImage3D:fe,scissor:we,viewport:me,reset:it}}function Yb(s,e,t,n,i,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new te,h=new WeakMap,u,d=new WeakMap,p=!1;try{p=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,M){return p?new OffscreenCanvas(w,M):ss("canvas")}function b(w,M,N){let j=1,Z=ye(w);if((Z.width>N||Z.height>N)&&(j=N/Math.max(Z.width,Z.height)),j<1)if(typeof HTMLImageElement!="undefined"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&w instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&w instanceof ImageBitmap||typeof VideoFrame!="undefined"&&w instanceof VideoFrame){let q=Math.floor(j*Z.width),_e=Math.floor(j*Z.height);u===void 0&&(u=g(q,_e));let oe=M?g(q,_e):u;return oe.width=q,oe.height=_e,oe.getContext("2d").drawImage(w,0,0,q,_e),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+q+"x"+_e+")."),oe}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),w;return w}function m(w){return w.generateMipmaps}function f(w){s.generateMipmap(w)}function x(w){return w.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?s.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function v(w,M,N,j,Z=!1){if(w!==null){if(s[w]!==void 0)return s[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let q=M;if(M===s.RED&&(N===s.FLOAT&&(q=s.R32F),N===s.HALF_FLOAT&&(q=s.R16F),N===s.UNSIGNED_BYTE&&(q=s.R8)),M===s.RED_INTEGER&&(N===s.UNSIGNED_BYTE&&(q=s.R8UI),N===s.UNSIGNED_SHORT&&(q=s.R16UI),N===s.UNSIGNED_INT&&(q=s.R32UI),N===s.BYTE&&(q=s.R8I),N===s.SHORT&&(q=s.R16I),N===s.INT&&(q=s.R32I)),M===s.RG&&(N===s.FLOAT&&(q=s.RG32F),N===s.HALF_FLOAT&&(q=s.RG16F),N===s.UNSIGNED_BYTE&&(q=s.RG8)),M===s.RG_INTEGER&&(N===s.UNSIGNED_BYTE&&(q=s.RG8UI),N===s.UNSIGNED_SHORT&&(q=s.RG16UI),N===s.UNSIGNED_INT&&(q=s.RG32UI),N===s.BYTE&&(q=s.RG8I),N===s.SHORT&&(q=s.RG16I),N===s.INT&&(q=s.RG32I)),M===s.RGB_INTEGER&&(N===s.UNSIGNED_BYTE&&(q=s.RGB8UI),N===s.UNSIGNED_SHORT&&(q=s.RGB16UI),N===s.UNSIGNED_INT&&(q=s.RGB32UI),N===s.BYTE&&(q=s.RGB8I),N===s.SHORT&&(q=s.RGB16I),N===s.INT&&(q=s.RGB32I)),M===s.RGBA_INTEGER&&(N===s.UNSIGNED_BYTE&&(q=s.RGBA8UI),N===s.UNSIGNED_SHORT&&(q=s.RGBA16UI),N===s.UNSIGNED_INT&&(q=s.RGBA32UI),N===s.BYTE&&(q=s.RGBA8I),N===s.SHORT&&(q=s.RGBA16I),N===s.INT&&(q=s.RGBA32I)),M===s.RGB&&N===s.UNSIGNED_INT_5_9_9_9_REV&&(q=s.RGB9_E5),M===s.RGBA){let _e=Z?ks:Be.getTransfer(j);N===s.FLOAT&&(q=s.RGBA32F),N===s.HALF_FLOAT&&(q=s.RGBA16F),N===s.UNSIGNED_BYTE&&(q=_e===Ke?s.SRGB8_ALPHA8:s.RGBA8),N===s.UNSIGNED_SHORT_4_4_4_4&&(q=s.RGBA4),N===s.UNSIGNED_SHORT_5_5_5_1&&(q=s.RGB5_A1)}return(q===s.R16F||q===s.R32F||q===s.RG16F||q===s.RG32F||q===s.RGBA16F||q===s.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function _(w,M){let N;return w?M===null||M===oi||M===Di?N=s.DEPTH24_STENCIL8:M===nn?N=s.DEPTH32F_STENCIL8:M===gs&&(N=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===oi||M===Di?N=s.DEPTH_COMPONENT24:M===nn?N=s.DEPTH_COMPONENT32F:M===gs&&(N=s.DEPTH_COMPONENT16),N}function R(w,M){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==At&&w.minFilter!==Ft?Math.log2(Math.max(M.width,M.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?M.mipmaps.length:1}function T(w){let M=w.target;M.removeEventListener("dispose",T),I(M),M.isVideoTexture&&h.delete(M)}function E(w){let M=w.target;M.removeEventListener("dispose",E),y(M)}function I(w){let M=n.get(w);if(M.__webglInit===void 0)return;let N=w.source,j=d.get(N);if(j){let Z=j[M.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&A(w),Object.keys(j).length===0&&d.delete(N)}n.remove(w)}function A(w){let M=n.get(w);s.deleteTexture(M.__webglTexture);let N=w.source,j=d.get(N);delete j[M.__cacheKey],a.memory.textures--}function y(w){let M=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(M.__webglFramebuffer[j]))for(let Z=0;Z<M.__webglFramebuffer[j].length;Z++)s.deleteFramebuffer(M.__webglFramebuffer[j][Z]);else s.deleteFramebuffer(M.__webglFramebuffer[j]);M.__webglDepthbuffer&&s.deleteRenderbuffer(M.__webglDepthbuffer[j])}else{if(Array.isArray(M.__webglFramebuffer))for(let j=0;j<M.__webglFramebuffer.length;j++)s.deleteFramebuffer(M.__webglFramebuffer[j]);else s.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&s.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&s.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let j=0;j<M.__webglColorRenderbuffer.length;j++)M.__webglColorRenderbuffer[j]&&s.deleteRenderbuffer(M.__webglColorRenderbuffer[j]);M.__webglDepthRenderbuffer&&s.deleteRenderbuffer(M.__webglDepthRenderbuffer)}let N=w.textures;for(let j=0,Z=N.length;j<Z;j++){let q=n.get(N[j]);q.__webglTexture&&(s.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(N[j])}n.remove(w)}let P=0;function z(){P=0}function k(){let w=P;return w>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+i.maxTextures),P+=1,w}function X(w){let M=[];return M.push(w.wrapS),M.push(w.wrapT),M.push(w.wrapR||0),M.push(w.magFilter),M.push(w.minFilter),M.push(w.anisotropy),M.push(w.internalFormat),M.push(w.format),M.push(w.type),M.push(w.generateMipmaps),M.push(w.premultiplyAlpha),M.push(w.flipY),M.push(w.unpackAlignment),M.push(w.colorSpace),M.join()}function W(w,M){let N=n.get(w);if(w.isVideoTexture&&ve(w),w.isRenderTargetTexture===!1&&w.version>0&&N.__version!==w.version){let j=w.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(N,w,M);return}}t.bindTexture(s.TEXTURE_2D,N.__webglTexture,s.TEXTURE0+M)}function G(w,M){let N=n.get(w);if(w.version>0&&N.__version!==w.version){Y(N,w,M);return}t.bindTexture(s.TEXTURE_2D_ARRAY,N.__webglTexture,s.TEXTURE0+M)}function J(w,M){let N=n.get(w);if(w.version>0&&N.__version!==w.version){Y(N,w,M);return}t.bindTexture(s.TEXTURE_3D,N.__webglTexture,s.TEXTURE0+M)}function H(w,M){let N=n.get(w);if(w.version>0&&N.__version!==w.version){ee(N,w,M);return}t.bindTexture(s.TEXTURE_CUBE_MAP,N.__webglTexture,s.TEXTURE0+M)}let ie={[ii]:s.REPEAT,[vn]:s.CLAMP_TO_EDGE,[is]:s.MIRRORED_REPEAT},ue={[At]:s.NEAREST,[ja]:s.NEAREST_MIPMAP_NEAREST,[Li]:s.NEAREST_MIPMAP_LINEAR,[Ft]:s.LINEAR,[ms]:s.LINEAR_MIPMAP_NEAREST,[_n]:s.LINEAR_MIPMAP_LINEAR},xe={[bu]:s.NEVER,[Su]:s.ALWAYS,[_u]:s.LESS,[Yc]:s.LEQUAL,[xu]:s.EQUAL,[Mu]:s.GEQUAL,[vu]:s.GREATER,[yu]:s.NOTEQUAL};function Le(w,M){if(M.type===nn&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Ft||M.magFilter===ms||M.magFilter===Li||M.magFilter===_n||M.minFilter===Ft||M.minFilter===ms||M.minFilter===Li||M.minFilter===_n)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(w,s.TEXTURE_WRAP_S,ie[M.wrapS]),s.texParameteri(w,s.TEXTURE_WRAP_T,ie[M.wrapT]),(w===s.TEXTURE_3D||w===s.TEXTURE_2D_ARRAY)&&s.texParameteri(w,s.TEXTURE_WRAP_R,ie[M.wrapR]),s.texParameteri(w,s.TEXTURE_MAG_FILTER,ue[M.magFilter]),s.texParameteri(w,s.TEXTURE_MIN_FILTER,ue[M.minFilter]),M.compareFunction&&(s.texParameteri(w,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(w,s.TEXTURE_COMPARE_FUNC,xe[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===At||M.minFilter!==Li&&M.minFilter!==_n||M.type===nn&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){let N=e.get("EXT_texture_filter_anisotropic");s.texParameterf(w,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,i.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function tt(w,M){let N=!1;w.__webglInit===void 0&&(w.__webglInit=!0,M.addEventListener("dispose",T));let j=M.source,Z=d.get(j);Z===void 0&&(Z={},d.set(j,Z));let q=X(M);if(q!==w.__cacheKey){Z[q]===void 0&&(Z[q]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,N=!0),Z[q].usedTimes++;let _e=Z[w.__cacheKey];_e!==void 0&&(Z[w.__cacheKey].usedTimes--,_e.usedTimes===0&&A(M)),w.__cacheKey=q,w.__webglTexture=Z[q].texture}return N}function Y(w,M,N){let j=s.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(j=s.TEXTURE_2D_ARRAY),M.isData3DTexture&&(j=s.TEXTURE_3D);let Z=tt(w,M),q=M.source;t.bindTexture(j,w.__webglTexture,s.TEXTURE0+N);let _e=n.get(q);if(q.version!==_e.__version||Z===!0){t.activeTexture(s.TEXTURE0+N);let oe=Be.getPrimaries(Be.workingColorSpace),fe=M.colorSpace===qn?null:Be.getPrimaries(M.colorSpace),Xe=M.colorSpace===qn||oe===fe?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,M.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,M.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xe);let $=b(M.image,!1,i.maxTextureSize);$=st(M,$);let pe=r.convert(M.format,M.colorSpace),Ae=r.convert(M.type),we=v(M.internalFormat,pe,Ae,M.colorSpace,M.isVideoTexture);Le(j,M);let me,Ve=M.mipmaps,Ue=M.isVideoTexture!==!0,it=_e.__version===void 0||Z===!0,D=q.dataReady,se=R(M,$);if(M.isDepthTexture)we=_(M.format===vi,M.type),it&&(Ue?t.texStorage2D(s.TEXTURE_2D,1,we,$.width,$.height):t.texImage2D(s.TEXTURE_2D,0,we,$.width,$.height,0,pe,Ae,null));else if(M.isDataTexture)if(Ve.length>0){Ue&&it&&t.texStorage2D(s.TEXTURE_2D,se,we,Ve[0].width,Ve[0].height);for(let V=0,K=Ve.length;V<K;V++)me=Ve[V],Ue?D&&t.texSubImage2D(s.TEXTURE_2D,V,0,0,me.width,me.height,pe,Ae,me.data):t.texImage2D(s.TEXTURE_2D,V,we,me.width,me.height,0,pe,Ae,me.data);M.generateMipmaps=!1}else Ue?(it&&t.texStorage2D(s.TEXTURE_2D,se,we,$.width,$.height),D&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,$.width,$.height,pe,Ae,$.data)):t.texImage2D(s.TEXTURE_2D,0,we,$.width,$.height,0,pe,Ae,$.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Ue&&it&&t.texStorage3D(s.TEXTURE_2D_ARRAY,se,we,Ve[0].width,Ve[0].height,$.depth);for(let V=0,K=Ve.length;V<K;V++)if(me=Ve[V],M.format!==Yt)if(pe!==null)if(Ue){if(D)if(M.layerUpdates.size>0){let le=tl(me.width,me.height,M.format,M.type);for(let ce of M.layerUpdates){let De=me.data.subarray(ce*le/me.data.BYTES_PER_ELEMENT,(ce+1)*le/me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,V,0,0,ce,me.width,me.height,1,pe,De)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,V,0,0,0,me.width,me.height,$.depth,pe,me.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,V,we,me.width,me.height,$.depth,0,me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ue?D&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,V,0,0,0,me.width,me.height,$.depth,pe,Ae,me.data):t.texImage3D(s.TEXTURE_2D_ARRAY,V,we,me.width,me.height,$.depth,0,pe,Ae,me.data)}else{Ue&&it&&t.texStorage2D(s.TEXTURE_2D,se,we,Ve[0].width,Ve[0].height);for(let V=0,K=Ve.length;V<K;V++)me=Ve[V],M.format!==Yt?pe!==null?Ue?D&&t.compressedTexSubImage2D(s.TEXTURE_2D,V,0,0,me.width,me.height,pe,me.data):t.compressedTexImage2D(s.TEXTURE_2D,V,we,me.width,me.height,0,me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ue?D&&t.texSubImage2D(s.TEXTURE_2D,V,0,0,me.width,me.height,pe,Ae,me.data):t.texImage2D(s.TEXTURE_2D,V,we,me.width,me.height,0,pe,Ae,me.data)}else if(M.isDataArrayTexture)if(Ue){if(it&&t.texStorage3D(s.TEXTURE_2D_ARRAY,se,we,$.width,$.height,$.depth),D)if(M.layerUpdates.size>0){let V=tl($.width,$.height,M.format,M.type);for(let K of M.layerUpdates){let le=$.data.subarray(K*V/$.data.BYTES_PER_ELEMENT,(K+1)*V/$.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,K,$.width,$.height,1,pe,Ae,le)}M.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,pe,Ae,$.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,we,$.width,$.height,$.depth,0,pe,Ae,$.data);else if(M.isData3DTexture)Ue?(it&&t.texStorage3D(s.TEXTURE_3D,se,we,$.width,$.height,$.depth),D&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,pe,Ae,$.data)):t.texImage3D(s.TEXTURE_3D,0,we,$.width,$.height,$.depth,0,pe,Ae,$.data);else if(M.isFramebufferTexture){if(it)if(Ue)t.texStorage2D(s.TEXTURE_2D,se,we,$.width,$.height);else{let V=$.width,K=$.height;for(let le=0;le<se;le++)t.texImage2D(s.TEXTURE_2D,le,we,V,K,0,pe,Ae,null),V>>=1,K>>=1}}else if(Ve.length>0){if(Ue&&it){let V=ye(Ve[0]);t.texStorage2D(s.TEXTURE_2D,se,we,V.width,V.height)}for(let V=0,K=Ve.length;V<K;V++)me=Ve[V],Ue?D&&t.texSubImage2D(s.TEXTURE_2D,V,0,0,pe,Ae,me):t.texImage2D(s.TEXTURE_2D,V,we,pe,Ae,me);M.generateMipmaps=!1}else if(Ue){if(it){let V=ye($);t.texStorage2D(s.TEXTURE_2D,se,we,V.width,V.height)}D&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,pe,Ae,$)}else t.texImage2D(s.TEXTURE_2D,0,we,pe,Ae,$);m(M)&&f(j),_e.__version=q.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function ee(w,M,N){if(M.image.length!==6)return;let j=tt(w,M),Z=M.source;t.bindTexture(s.TEXTURE_CUBE_MAP,w.__webglTexture,s.TEXTURE0+N);let q=n.get(Z);if(Z.version!==q.__version||j===!0){t.activeTexture(s.TEXTURE0+N);let _e=Be.getPrimaries(Be.workingColorSpace),oe=M.colorSpace===qn?null:Be.getPrimaries(M.colorSpace),fe=M.colorSpace===qn||_e===oe?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,M.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,M.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe);let Xe=M.isCompressedTexture||M.image[0].isCompressedTexture,$=M.image[0]&&M.image[0].isDataTexture,pe=[];for(let K=0;K<6;K++)!Xe&&!$?pe[K]=b(M.image[K],!0,i.maxCubemapSize):pe[K]=$?M.image[K].image:M.image[K],pe[K]=st(M,pe[K]);let Ae=pe[0],we=r.convert(M.format,M.colorSpace),me=r.convert(M.type),Ve=v(M.internalFormat,we,me,M.colorSpace),Ue=M.isVideoTexture!==!0,it=q.__version===void 0||j===!0,D=Z.dataReady,se=R(M,Ae);Le(s.TEXTURE_CUBE_MAP,M);let V;if(Xe){Ue&&it&&t.texStorage2D(s.TEXTURE_CUBE_MAP,se,Ve,Ae.width,Ae.height);for(let K=0;K<6;K++){V=pe[K].mipmaps;for(let le=0;le<V.length;le++){let ce=V[le];M.format!==Yt?we!==null?Ue?D&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,le,0,0,ce.width,ce.height,we,ce.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,le,Ve,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ue?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,le,0,0,ce.width,ce.height,we,me,ce.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,le,Ve,ce.width,ce.height,0,we,me,ce.data)}}}else{if(V=M.mipmaps,Ue&&it){V.length>0&&se++;let K=ye(pe[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,se,Ve,K.width,K.height)}for(let K=0;K<6;K++)if($){Ue?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,pe[K].width,pe[K].height,we,me,pe[K].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ve,pe[K].width,pe[K].height,0,we,me,pe[K].data);for(let le=0;le<V.length;le++){let De=V[le].image[K].image;Ue?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,le+1,0,0,De.width,De.height,we,me,De.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,le+1,Ve,De.width,De.height,0,we,me,De.data)}}else{Ue?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,we,me,pe[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ve,we,me,pe[K]);for(let le=0;le<V.length;le++){let ce=V[le];Ue?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,le+1,0,0,we,me,ce.image[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,le+1,Ve,we,me,ce.image[K])}}}m(M)&&f(s.TEXTURE_CUBE_MAP),q.__version=Z.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function be(w,M,N,j,Z,q){let _e=r.convert(N.format,N.colorSpace),oe=r.convert(N.type),fe=v(N.internalFormat,_e,oe,N.colorSpace),Xe=n.get(M),$=n.get(N);if($.__renderTarget=M,!Xe.__hasExternalTextures){let pe=Math.max(1,M.width>>q),Ae=Math.max(1,M.height>>q);Z===s.TEXTURE_3D||Z===s.TEXTURE_2D_ARRAY?t.texImage3D(Z,q,fe,pe,Ae,M.depth,0,_e,oe,null):t.texImage2D(Z,q,fe,pe,Ae,0,_e,oe,null)}t.bindFramebuffer(s.FRAMEBUFFER,w),He(M)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,j,Z,$.__webglTexture,0,Ge(M)):(Z===s.TEXTURE_2D||Z>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,j,Z,$.__webglTexture,q),t.bindFramebuffer(s.FRAMEBUFFER,null)}function ae(w,M,N){if(s.bindRenderbuffer(s.RENDERBUFFER,w),M.depthBuffer){let j=M.depthTexture,Z=j&&j.isDepthTexture?j.type:null,q=_(M.stencilBuffer,Z),_e=M.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,oe=Ge(M);He(M)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,oe,q,M.width,M.height):N?s.renderbufferStorageMultisample(s.RENDERBUFFER,oe,q,M.width,M.height):s.renderbufferStorage(s.RENDERBUFFER,q,M.width,M.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,_e,s.RENDERBUFFER,w)}else{let j=M.textures;for(let Z=0;Z<j.length;Z++){let q=j[Z],_e=r.convert(q.format,q.colorSpace),oe=r.convert(q.type),fe=v(q.internalFormat,_e,oe,q.colorSpace),Xe=Ge(M);N&&He(M)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Xe,fe,M.width,M.height):He(M)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Xe,fe,M.width,M.height):s.renderbufferStorage(s.RENDERBUFFER,fe,M.width,M.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Te(w,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,w),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let j=n.get(M.depthTexture);j.__renderTarget=M,(!j.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),W(M.depthTexture,0);let Z=j.__webglTexture,q=Ge(M);if(M.depthTexture.format===bi)He(M)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Z,0,q):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Z,0);else if(M.depthTexture.format===vi)He(M)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Z,0,q):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Pe(w){let M=n.get(w),N=w.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==w.depthTexture){let j=w.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),j){let Z=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,j.removeEventListener("dispose",Z)};j.addEventListener("dispose",Z),M.__depthDisposeCallback=Z}M.__boundDepthTexture=j}if(w.depthTexture&&!M.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");Te(M.__webglFramebuffer,w)}else if(N){M.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(t.bindFramebuffer(s.FRAMEBUFFER,M.__webglFramebuffer[j]),M.__webglDepthbuffer[j]===void 0)M.__webglDepthbuffer[j]=s.createRenderbuffer(),ae(M.__webglDepthbuffer[j],w,!1);else{let Z=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,q=M.__webglDepthbuffer[j];s.bindRenderbuffer(s.RENDERBUFFER,q),s.framebufferRenderbuffer(s.FRAMEBUFFER,Z,s.RENDERBUFFER,q)}}else if(t.bindFramebuffer(s.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=s.createRenderbuffer(),ae(M.__webglDepthbuffer,w,!1);else{let j=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Z=M.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,Z),s.framebufferRenderbuffer(s.FRAMEBUFFER,j,s.RENDERBUFFER,Z)}t.bindFramebuffer(s.FRAMEBUFFER,null)}function ke(w,M,N){let j=n.get(w);M!==void 0&&be(j.__webglFramebuffer,w,w.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),N!==void 0&&Pe(w)}function at(w){let M=w.texture,N=n.get(w),j=n.get(M);w.addEventListener("dispose",E);let Z=w.textures,q=w.isWebGLCubeRenderTarget===!0,_e=Z.length>1;if(_e||(j.__webglTexture===void 0&&(j.__webglTexture=s.createTexture()),j.__version=M.version,a.memory.textures++),q){N.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(M.mipmaps&&M.mipmaps.length>0){N.__webglFramebuffer[oe]=[];for(let fe=0;fe<M.mipmaps.length;fe++)N.__webglFramebuffer[oe][fe]=s.createFramebuffer()}else N.__webglFramebuffer[oe]=s.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){N.__webglFramebuffer=[];for(let oe=0;oe<M.mipmaps.length;oe++)N.__webglFramebuffer[oe]=s.createFramebuffer()}else N.__webglFramebuffer=s.createFramebuffer();if(_e)for(let oe=0,fe=Z.length;oe<fe;oe++){let Xe=n.get(Z[oe]);Xe.__webglTexture===void 0&&(Xe.__webglTexture=s.createTexture(),a.memory.textures++)}if(w.samples>0&&He(w)===!1){N.__webglMultisampledFramebuffer=s.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let oe=0;oe<Z.length;oe++){let fe=Z[oe];N.__webglColorRenderbuffer[oe]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,N.__webglColorRenderbuffer[oe]);let Xe=r.convert(fe.format,fe.colorSpace),$=r.convert(fe.type),pe=v(fe.internalFormat,Xe,$,fe.colorSpace,w.isXRRenderTarget===!0),Ae=Ge(w);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ae,pe,w.width,w.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+oe,s.RENDERBUFFER,N.__webglColorRenderbuffer[oe])}s.bindRenderbuffer(s.RENDERBUFFER,null),w.depthBuffer&&(N.__webglDepthRenderbuffer=s.createRenderbuffer(),ae(N.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(q){t.bindTexture(s.TEXTURE_CUBE_MAP,j.__webglTexture),Le(s.TEXTURE_CUBE_MAP,M);for(let oe=0;oe<6;oe++)if(M.mipmaps&&M.mipmaps.length>0)for(let fe=0;fe<M.mipmaps.length;fe++)be(N.__webglFramebuffer[oe][fe],w,M,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+oe,fe);else be(N.__webglFramebuffer[oe],w,M,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);m(M)&&f(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let oe=0,fe=Z.length;oe<fe;oe++){let Xe=Z[oe],$=n.get(Xe);t.bindTexture(s.TEXTURE_2D,$.__webglTexture),Le(s.TEXTURE_2D,Xe),be(N.__webglFramebuffer,w,Xe,s.COLOR_ATTACHMENT0+oe,s.TEXTURE_2D,0),m(Xe)&&f(s.TEXTURE_2D)}t.unbindTexture()}else{let oe=s.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(oe=w.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(oe,j.__webglTexture),Le(oe,M),M.mipmaps&&M.mipmaps.length>0)for(let fe=0;fe<M.mipmaps.length;fe++)be(N.__webglFramebuffer[fe],w,M,s.COLOR_ATTACHMENT0,oe,fe);else be(N.__webglFramebuffer,w,M,s.COLOR_ATTACHMENT0,oe,0);m(M)&&f(oe),t.unbindTexture()}w.depthBuffer&&Pe(w)}function We(w){let M=w.textures;for(let N=0,j=M.length;N<j;N++){let Z=M[N];if(m(Z)){let q=x(w),_e=n.get(Z).__webglTexture;t.bindTexture(q,_e),f(q),t.unbindTexture()}}}let pt=[],L=[];function Kt(w){if(w.samples>0){if(He(w)===!1){let M=w.textures,N=w.width,j=w.height,Z=s.COLOR_BUFFER_BIT,q=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,_e=n.get(w),oe=M.length>1;if(oe)for(let fe=0;fe<M.length;fe++)t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+fe,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+fe,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let fe=0;fe<M.length;fe++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(Z|=s.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(Z|=s.STENCIL_BUFFER_BIT)),oe){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,_e.__webglColorRenderbuffer[fe]);let Xe=n.get(M[fe]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Xe,0)}s.blitFramebuffer(0,0,N,j,0,0,N,j,Z,s.NEAREST),c===!0&&(pt.length=0,L.length=0,pt.push(s.COLOR_ATTACHMENT0+fe),w.depthBuffer&&w.resolveDepthBuffer===!1&&(pt.push(q),L.push(q),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,L)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,pt))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),oe)for(let fe=0;fe<M.length;fe++){t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+fe,s.RENDERBUFFER,_e.__webglColorRenderbuffer[fe]);let Xe=n.get(M[fe]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+fe,s.TEXTURE_2D,Xe,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&c){let M=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[M])}}}function Ge(w){return Math.min(i.maxSamples,w.samples)}function He(w){let M=n.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function ve(w){let M=a.render.frame;h.get(w)!==M&&(h.set(w,M),w.update())}function st(w,M){let N=w.colorSpace,j=w.format,Z=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||N!==Tt&&N!==qn&&(Be.getTransfer(N)===Ke?(j!==Yt||Z!==Rn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),M}function ye(w){return typeof HTMLImageElement!="undefined"&&w instanceof HTMLImageElement?(l.width=w.naturalWidth||w.width,l.height=w.naturalHeight||w.height):typeof VideoFrame!="undefined"&&w instanceof VideoFrame?(l.width=w.displayWidth,l.height=w.displayHeight):(l.width=w.width,l.height=w.height),l}this.allocateTextureUnit=k,this.resetTextureUnits=z,this.setTexture2D=W,this.setTexture2DArray=G,this.setTexture3D=J,this.setTextureCube=H,this.rebindTextures=ke,this.setupRenderTarget=at,this.updateRenderTargetMipmap=We,this.updateMultisampleRenderTarget=Kt,this.setupDepthRenderbuffer=Pe,this.setupFrameBufferTexture=be,this.useMultisampledRTT=He}function jb(s,e){function t(n,i=qn){let r,a=Be.getTransfer(i);if(n===Rn)return s.UNSIGNED_BYTE;if(n===Ja)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Za)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Bc)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Nc)return s.BYTE;if(n===Oc)return s.SHORT;if(n===gs)return s.UNSIGNED_SHORT;if(n===Ka)return s.INT;if(n===oi)return s.UNSIGNED_INT;if(n===nn)return s.FLOAT;if(n===sn)return s.HALF_FLOAT;if(n===kc)return s.ALPHA;if(n===zc)return s.RGB;if(n===Yt)return s.RGBA;if(n===Gc)return s.LUMINANCE;if(n===Hc)return s.LUMINANCE_ALPHA;if(n===bi)return s.DEPTH_COMPONENT;if(n===vi)return s.DEPTH_STENCIL;if(n===Qa)return s.RED;if(n===$a)return s.RED_INTEGER;if(n===Vc)return s.RG;if(n===eo)return s.RG_INTEGER;if(n===to)return s.RGBA_INTEGER;if(n===xr||n===vr||n===yr||n===Mr)if(a===Ke)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===xr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===vr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===yr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Mr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===xr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===vr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===yr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Mr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===no||n===io||n===so||n===ro)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===no)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===io)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===so)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ro)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ao||n===oo||n===co)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ao||n===oo)return a===Ke?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===co)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===lo||n===ho||n===uo||n===fo||n===po||n===mo||n===go||n===bo||n===_o||n===xo||n===vo||n===yo||n===Mo||n===So)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===lo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ho)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===uo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===fo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===po)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===mo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===go)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===bo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===_o)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===xo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===vo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===yo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Mo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===So)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Sr||n===Ao||n===To)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Sr)return a===Ke?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ao)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===To)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Wc||n===wo||n===Eo||n===Ro)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Sr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===wo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Eo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ro)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Di?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}var Kb={type:"move"},Er=class{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new zt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new zt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new C,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new C),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new zt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new C,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new C),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){let t=this._hand;if(t)for(let n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,r=null,a=null,o=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){a=!0;for(let b of e.hand.values()){let m=t.getJointPose(b,n),f=this._getHandJoint(l,b);m!==null&&(f.matrix.fromArray(m.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=m.radius),f.visible=m!==null}let h=l.joints["index-finger-tip"],u=l.joints["thumb-tip"],d=h.position.distanceTo(u.position),p=.02,g=.005;l.inputState.pinching&&d>p+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=p-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));o!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&r!==null&&(i=r),i!==null&&(o.matrix.fromArray(i.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,i.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(i.linearVelocity)):o.hasLinearVelocity=!1,i.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(i.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Kb)))}return o!==null&&(o.visible=i!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){let n=new zt;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}},Jb=`
void main() {
...
void main(){
  ...
  gl_FragColor=vec4(col,1.0);
}`,S0={gradient:md,fluid:b0,aurora:_0,plasma:v0,ember:y0,dots:M0,silk:x0};function Kl(s,e){let t=i=>{i.preventDefault(),e.pause(),window.dispatchEvent(new Event("three-context-lost"))},n=()=>{e.resume(),window.dispatchEvent(new Event("three-context-restored"))};return s.addEventListener("webglcontextlost",t),s.addEventListener("webglcontextrestored",n),()=>{s.removeEventListener("webglcontextlost",t),s.removeEventListener("webglcontextrestored",n)}}function A0(s,e,t){var R,T;let n=(R=s.parentElement)!=null?R:s,i=n.clientWidth||800,r=n.clientHeight||600,a=new ys({canvas:s,antialias:!0});a.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),a.setSize(i,r,!1);let o=Kl(s,{pause:()=>{cancelAnimationFrame(p),p=0},resume:()=>{g&&!p&&(p=requestAnimationFrame(x))}}),c=new zn,l=new Ti,h=a.getPixelRatio(),u=new ft({vertexShader:g0,fragmentShader:(T=S0[e.shader])!=null?T:md,uniforms:{iTime:{value:6},iResolution:{value:new te(i*h,r*h)}}}),d=new ai(2,2);c.add(new Oe(d,u));let p=0,g=!0,b=!0,m=performance.now();function f(){let E=n.clientWidth||i,I=n.clientHeight||r;a.setSize(E,I,!1);let A=a.getPixelRatio();u.uniforms.iResolution.value.set(E*A,I*A)}function x(){var E;u.uniforms.iTime.value=6+(performance.now()-m)/1e3,a.render(c,l),b&&(b=!1,(E=t.onReady)==null||E.call(t),window.dispatchEvent(new Event("three-ready"))),g?p=requestAnimationFrame(x):p=0}let v=new IntersectionObserver(E=>{var I,A;g=(A=(I=E[0])==null?void 0:I.isIntersecting)!=null?A:!0,g&&!p&&(p=requestAnimationFrame(x))});v.observe(n);let _=()=>{document.visibilityState==="hidden"?(cancelAnimationFrame(p),p=0):g&&!p&&(p=requestAnimationFrame(x))};return document.addEventListener("visibilitychange",_),window.addEventListener("resize",f),p=requestAnimationFrame(x),{dispose(){o(),cancelAnimationFrame(p),v.disconnect(),document.removeEventListener("visibilitychange",_),window.removeEventListener("resize",f),d.dispose(),u.dispose(),a.dispose()}}}function T0(s,e,t){var A;let n=(A=s.parentElement)!=null?A:s,i=n.clientWidth||800,r=n.clientHeight||600,a=new ys({canvas:s,antialias:!0,alpha:!0});a.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),a.setSize(i,r,!1),a.toneMapping=Ci,a.toneMappingExposure=1.05,a.outputColorSpace=ot;let o=Kl(s,{pause:()=>{cancelAnimationFrame(b),b=0},resume:()=>{m&&!b&&(b=requestAnimationFrame(R))}}),c=new zn,l=new zi(a),h=new Rr,u=l.fromScene(h,.04);h.dispose(),c.environment=u.texture;let d=new mt(40,i/r,.01,1e3),p=new en(16777215,1.6);if(p.position.set(4,6,5),c.add(p),e.accentLinked){let y=new en(new he(e.accentColor),3.4);y.position.set(-5,3,-6),c.add(y);let P=new en(new he(e.accentColor),1.6);P.position.set(5,-1,-5),c.add(P);let z=new en(new he(e.accentColor),.7);z.position.set(3,-2,4),c.add(z)}let g=new zt;c.add(g);let b=0,m=!0,f=!0,x=!1,v=!1;function _(){let y=n.clientWidth||i,P=n.clientHeight||r;a.setSize(y,P,!1),d.aspect=y/P,d.updateProjectionMatrix()}function R(){var y;g.rotation.y+=.006,a.render(c,d),f&&x&&(f=!1,(y=t.onReady)==null||y.call(t),window.dispatchEvent(new Event("three-ready"))),m?b=requestAnimationFrame(R):b=0}let T=new Do;T.setMeshoptDecoder(hd),T.load(e.modelUrl,y=>{if(v){y.scene.traverse(J=>{if(J.geometry&&J.geometry.dispose(),J.material){let H=["map","normalMap","roughnessMap","metalnessMap","aoMap","emissiveMap","clearcoatMap","clearcoatNormalMap","clearcoatRoughnessMap","iridescenceMap","iridescenceThicknessMap","sheenColorMap","sheenRoughnessMap","specularMap","specularIntensityMap","specularColorMap","transmissionMap","thicknessMap","envMap","lightMap","bumpMap","displacementMap","alphaMap"],ie=Array.isArray(J.material)?J.material:[J.material];for(let ue of ie){for(let xe of H){let Le=ue[xe];Le&&typeof Le.dispose=="function"&&Le.dispose()}ue.dispose()}}});return}let P=y.scene,z=new Nt().setFromObject(P),k=z.getSize(new C),X=z.getCenter(new C);P.position.sub(X);let W=Math.max(k.x,k.y,k.z)||1,G=W/2/Math.tan(Tr.degToRad(40/2));d.position.set(0,W*.05,G*1.9),d.lookAt(0,0,0),g.add(P),_(),x=!0,b||(b=requestAnimationFrame(R))},void 0,y=>{var P;v||((P=t.onReady)==null||P.call(t),window.dispatchEvent(new Event("three-ready")))});let E=new IntersectionObserver(y=>{var P,z;m=(z=(P=y[0])==null?void 0:P.isIntersecting)!=null?z:!0,m&&!b&&(b=requestAnimationFrame(R))});E.observe(n);let I=()=>{document.visibilityState==="hidden"?(cancelAnimationFrame(b),b=0):m&&!b&&(b=requestAnimationFrame(R))};return document.addEventListener("visibilitychange",I),window.addEventListener("resize",_),b=requestAnimationFrame(R),{dispose(){v=!0,o(),cancelAnimationFrame(b),E.disconnect(),document.removeEventListener("visibilitychange",I),window.removeEventListener("resize",_),g.traverse(y=>{if(y.geometry&&y.geometry.dispose(),y.material){let P=["map","normalMap","roughnessMap","metalnessMap","aoMap","emissiveMap","clearcoatMap","clearcoatNormalMap","clearcoatRoughnessMap","iridescenceMap","iridescenceThicknessMap","sheenColorMap","sheenRoughnessMap","specularMap","specularIntensityMap","specularColorMap","transmissionMap","thicknessMap","envMap","lightMap","bumpMap","displacementMap","alphaMap"],z=Array.isArray(y.material)?y.material:[y.material];for(let k of z){for(let X of P){let W=k[X];W&&typeof W.dispose=="function"&&W.dispose()}k.dispose()}}}),u.dispose(),l.dispose(),a.dispose()}}}function pd(s,e,t){switch(s){case"torus":return new or(e,e*.4,48,128);case"torusKnot":return new cr(e*.7,e*.26,220,32);case"icosa":return new us(e,0);case"plane":return new ai(e*2.4,e*1.5,64,64);case"blob":return new us(e,8);default:return new ar(e,96,96)}}function w0(s,e){return e?new xt({transmission:1,thickness:1.2,roughness:.04,ior:1.9,dispersion:.95,iridescence:1,iridescenceIOR:1.4,iridescenceThicknessRange:[120,700],clearcoat:.5,clearcoatRoughness:.08,metalness:0,transparent:!0,color:new he(16777215),attenuationColor:new he(s.accentColor),attenuationDistance:9,flatShading:!0,envMapIntensity:s.envIntensity}):new xt({transmission:1,thickness:1,roughness:.13,ior:1.5,dispersion:.5,iridescence:1,iridescenceIOR:1.4,iridescenceThicknessRange:[130,740],clearcoat:.6,clearcoatRoughness:.12,metalness:0,transparent:!0,color:new he(16777215),attenuationColor:new he(s.accentColor),attenuationDistance:4.5,envMapIntensity:s.envIntensity})}function E0(){let s=document.createElement("canvas");s.width=1024,s.height=512;let e=s.getContext("2d"),t=e.createLinearGradient(0,0,1024,0);t.addColorStop(0,"#3a1c71"),t.addColorStop(.22,"#d76d77"),t.addColorStop(.45,"#ffaf7b"),t.addColorStop(.68,"#2bd2ff"),t.addColorStop(.85,"#7c5cff"),t.addColorStop(1,"#ff3cc8"),e.fillStyle=t,e.fillRect(0,0,1024,512);let n=new $s(s);return n.mapping=ps,n.colorSpace=ot,n}function R0(s){return new xt({metalness:.6,roughness:.12,iridescence:1,iridescenceIOR:1.6,iridescenceThicknessRange:[100,900],clearcoat:1,clearcoatRoughness:.08,color:new he(1118488),envMapIntensity:s.envIntensity})}function Ho(s,e,t=!1){return s==="iridescent"?R0(e):s==="glass"?w0(e,t):s==="chrome"?new xt({metalness:1,roughness:.03,iridescence:1,iridescenceIOR:1.3,iridescenceThicknessRange:[100,520],clearcoat:1,clearcoatRoughness:.04,color:new he(16448250),envMapIntensity:e.envIntensity}):s==="metal"?new Xt({color:new he(e.accentColor),metalness:1,roughness:.25,envMapIntensity:e.envIntensity}):s==="emissive"?new wt({color:new he(e.accentColor),wireframe:!0}):new Xt({color:new he(e.color),emissive:new he(e.emissive),emissiveIntensity:0,roughness:e.roughness,metalness:e.metalness,envMapIntensity:e.envIntensity,transparent:e.opacity<1,opacity:e.opacity})}function C0(s){let t=new Float32Array(2100);for(let i=0;i<700;i++){let r=s.radius*(.4+Math.cbrt((i+1)/700)*1.3),a=i*2.399963,o=Math.acos(1-2*((i+.5)/700));t[i*3]=r*Math.sin(o)*Math.cos(a),t[i*3+1]=r*Math.sin(o)*Math.sin(a),t[i*3+2]=r*Math.cos(o)}let n=new dt;return n.setAttribute("position",new ut(t,3)),new Ei(n,new ri({color:new he(s.accentColor),size:.045,transparent:!0,opacity:.9,depthWrite:!1}))}function gd(s,e,t={}){var X;let n=fd(e);if(n.shader)return A0(s,n,t);if(n.modelUrl)return T0(s,n,t);let i=n.materialKind==="emissive",r=(X=s.parentElement)!=null?X:s,a=r.clientWidth||800,o=r.clientHeight||600,c=new ys({canvas:s,antialias:!0,alpha:!0,powerPreference:"high-performance"});c.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),c.setSize(a,o,!1),c.toneMapping=i?bn:Ci,c.toneMappingExposure=n.exposure,c.outputColorSpace=ot;let l=Kl(s,{pause:()=>{cancelAnimationFrame(T),T=0},resume:()=>{E&&!T&&(T=requestAnimationFrame(P))}}),h=new zn,u=new zi(c),d;if(n.materialKind==="iridescent"){let W=E0();d=u.fromEquirectangular(W),W.dispose()}else{let W=new Rr;d=u.fromScene(W,.04),W.dispose()}h.environment=d.texture;let p=new mt(40,a/o,.1,100);p.position.set(0,0,n.cameraZ+2.5);let g=new en(16777215,2);g.position.set(4,5,6),h.add(g);let b=new en(16777215,1);b.position.set(-5,-2,3),h.add(b);let m=[],f=W=>(W.traverse(G=>{G.geometry&&m.push(G.geometry),G.material&&m.push(G.material)}),W),x=new zt;if(n.geometryKind==="particles")x.add(f(C0(n)));else if(n.cluster&&n.materialKind!=="emissive"&&n.materialKind!=="iridescent"){let W=n.geometryKind==="icosa",G=new Oe(pd(n.geometryKind,n.radius*.75,n.segments),Ho(n.materialKind,n,W));G.position.set(.1,.55,0);let J=new Oe(new Fo(n.radius*1.05,n.radius*1.05,n.radius*1.05,8,n.radius*.26),Ho(n.materialKind,n,!1));J.position.set(-.15,-.55,.25),J.rotation.set(.2,.5,.05);let H=new Oe(new rr(n.radius*.4,n.radius*.9,24,48),Ho(n.materialKind,n,!1));H.position.set(1.1,-.05,-.15),H.rotation.z=.95,x.add(f(G),f(J),f(H)),x.position.set(1.2,0,0),x.rotation.y=-.15}else{let W=n.geometryKind==="icosa";x.add(f(new Oe(pd(n.geometryKind,n.radius,n.segments),Ho(n.materialKind,n,W))))}h.add(x);let v=null,_=null,R=null;i&&(v=new ko(c),v.addPass(new zo(h,p)),_=new Ts(new te(a,o),.95,.55,0),v.addPass(_),R=new Go,v.addPass(R));let T=0,E=!0,I=!0,A=performance.now();function y(){let W=r.clientWidth||a,G=r.clientHeight||o;c.setSize(W,G,!1),p.aspect=W/G,p.updateProjectionMatrix(),v==null||v.setSize(W,G)}function P(){var G;let W=(performance.now()-A)/1e3;x.children.forEach(J=>{J.rotation.y=W*n.rotationSpeed}),x.position.y=Math.sin(W*.8)*n.driftAmplitude,v?v.render():c.render(h,p),I&&(I=!1,(G=t.onReady)==null||G.call(t),window.dispatchEvent(new Event("three-ready"))),E?T=requestAnimationFrame(P):T=0}let z=new IntersectionObserver(W=>{var G,J;E=(J=(G=W[0])==null?void 0:G.isIntersecting)!=null?J:!0,E&&!T&&(T=requestAnimationFrame(P))});z.observe(r);let k=()=>{document.visibilityState==="hidden"?(cancelAnimationFrame(T),T=0):E&&!T&&(T=requestAnimationFrame(P))};return document.addEventListener("visibilitychange",k),window.addEventListener("resize",y),T=requestAnimationFrame(P),{dispose(){l(),cancelAnimationFrame(T),z.disconnect(),document.removeEventListener("visibilitychange",k),window.removeEventListener("resize",y);for(let W of m)W.dispose();v==null||v.dispose(),_==null||_.dispose(),R==null||R.dispose(),d.dispose(),u.dispose(),c.dispose()}}}window.OpenLen3D={mount:gd};})();
