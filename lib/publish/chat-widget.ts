...
const STRINGS: Record<string, ChatStrings> = {
  ...
  ko: { title: "메시지", login: "로그인", register: "가입", username: "사용자 이름", password: "비밀번호", displayName: "표시 이름 (선택)", loginBtn: "로그인", registerBtn: "계정 만들기", inviteOnly: "이 공간은 초대 전용입니다.", errBadUser: "잘못된 사용자 이름입니다.", errBadPass: "비밀번호가 너무 짧습니다.", errTaken: "이미 사용 중인 사용자 이름입니다.", errInvalid: "사용자 이름 또는 비밀번호가 틀렸습니다.", errRate: "시도가 너무 많습니다. 잠시 기다려 주세요.", search: "@사용자 검색", noConvos: "아직 대화가 없습니다.", noUsers: "사용자를 찾을 수 없습니다.", compose: "메시지 입력…", send: "보내기", back: "뒤로", logout: "로그아웃", open: "채팅 열기", close: "닫기", error: "문제가 발생했습니다.", messageBusiness: "비즈니스에 메시지" },
  zh: { title: "消息", login: "登录", register: "注册", username: "用户名", password: "密码", displayName: "显示名称（可选）", loginBtn: "登录", registerBtn: "创建账户", inviteOnly: "此空间仅限邀请。", errBadUser: "用户名无效。", errBadPass: "密码太短。", errTaken: "该用户名已被占用。", errInvalid: "用户名或密码错误。", errRate: "尝试次数过多，请稍候。", search: "搜索 @用户名", noConvos: "还没有会话。", noUsers: "未找到用户。", compose: "写条消息…", send: "发送", back: "返回", logout: "退出", open: "打开聊天", close: "关闭", error: "出了点问题。", messageBusiness: "联系商家" },
  nl: { title: "Berichten", login: "Inloggen", register: "Registreren", username: "Gebruikersnaam", password: "Wachtwoord", displayName: "Weergavenaam (optioneel)", loginBtn: "Inloggen", registerBtn: "Account aanmaken", inviteOnly: "Deze ruimte is alleen op uitnodiging.", errBadUser: "Ongeldige gebruikersnaam.", errBadPass: "Het wachtwoord is te kort.", errTaken: "Die gebruikersnaam is al in gebruik.", errInvalid: "Gebruikersnaam of wachtwoord onjuist.", errRate: "Te veel pogingen. Wacht even.", search: "Zoek @gebruiker", noConvos: "Nog geen gesprekken.", noUsers: "Geen gebruikers gevonden.", compose: "Schrijf een bericht…", send: "Versturen", back: "Terug", logout: "Uitloggen", open: "Chat openen", close: "Sluiten", error: "Er ging iets mis.", messageBusiness: "Bericht naar het bedrijf" },
};
...
tbar.appendChild(bk);tbar.appendChild(el("div","who",who));
...
comp.addEventListener("submit",function(e){e.preventDefault();var v=(ci.value||"").trim();if(!v)return;cb.disabled=true;
