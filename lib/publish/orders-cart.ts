...
var st=document.createElement("style");st.textContent=".bar{position:fixed;left:50%;transform:translateX(-50%);bottom:16px;z-index:2147482000;display:none;align-items:center;gap:12px;background:#16181d;color:#fff;border-radius:999px;padding:10px 10px 10px 18px;box-shadow:0 8px 30px rgba(0,0,0,.35);font:600 14px/1 system-ui,sans-serif;max-width:92vw}.bar.on{display:flex}.bar button{cursor:pointer;border:0;border-radius:999px;padding:10px 16px;background:#25D366;color:#fff;font:700 13.5px/1 system-ui,sans-serif;white-space:nowrap}.panel{position:fixed;left:50%;transform:translateX(-50%);bottom:76px;z-index:2147482001;display:none;flex-direction:column;gap:10px;width:min(360px,92vw);max-height:60vh;overflow:auto;background:#fff;color:#16181d;border-radius:16px;padding:16px;box-shadow:0 12px 40px rgba(0,0,0,.3);font:400 14px/1.4 system-ui,sans-serif}.panel.on{display:flex}.panel h4{margin:0;font-size:15px}.row{display:flex;align-items:center;gap:8px}.row .t{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.row button{cursor:pointer;border:1px solid #d8d8de;background:#fff;border-radius:8px;width:26px;height:26px;font-weight:700}.row .q{min-width:16px;text-align:center;font-weight:700}.panel textarea{border:1px solid #d8d8de;border-radius:10px;padding:8px 10px;font:inherit;resize:vertical;min-height:44px}.panel .tot{font-weight:700}.panel .send{cursor:pointer;border:0;border-radius:12px;padding:12px;background:#25D366;color:#fff;font:700 14px/1 system-ui,sans-serif}";
root.appendChild(st);
