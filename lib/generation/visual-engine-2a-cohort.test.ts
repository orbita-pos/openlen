...
const EXPECTED_IDENTITY_AND_STRUCTURE = [
  ...
  ["open-source-observability-es", { structuralPattern: "product landing page pattern with hero, features, how-it-works, testimonials, CTA, and footer", baselineIdentity: "minimalist, modern, clean, functional; code snippets, UI components, buttons, badges, switches, cards, avatars, progress bars, testimonials, logos, and charts", requestedIdentity: "constructivist print system in red, cream, and black" }, "Retains the hero, features, how-it-works, testimonials, CTA, and footer roles; capabilities, workflow, proof, and contribution require no role change."],
