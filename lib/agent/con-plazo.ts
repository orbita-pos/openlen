...
/**
 * Corre `trabajo` contra un plazo de `ms`. Si gana el plazo, o si `trabajo`
 * termina en error, devuelve `siNo` — nunca deja que una base lenta o un
 * fallo tumben al llamador.
 *
