  ...
  return [
    ...
    },
    {
      ...
      description:
        ...
        // 🔴 LA CLÁUSULA DEL RECHAZO, y estaba en NINGÚN sitio. El binario se la
        // dice al modelo en su propia descripción —«If they decline you will not
        // be notified — do not ask about the decision and do not re-propose the
        // same or a reworded condition»— y aquí sólo vivía en un comentario de
