...
describe("runAgentLoop", () => {
  ...
  // hace el binario de Claude Code (`<interrupted-output>`). Este caso sigue
...
describe("runAgentLoop — declarar_tareas", () => {
   ...
   *
   * Es lo que hace el binario de Claude Code, medido en 2.1.260: cuenta
...
describe("el objetivo", () => {
  ...
  //
  // 🔴 LA VARA ES EL BINARIO, y ahí el objetivo NO es un dato copiado al arrancar
