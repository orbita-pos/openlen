...
export interface EvalCase {
   ...
   *
   * 🔴 ES UN DATO QUE SE REPORTA Y NO PUNTÚA — la figura que el binario de
 ...
 * literalmente la regla del binario de Claude Code — «when you stop before the
...
export const EVAL_CASES: EvalCase[] = [
  ...
  //
  // La vara es la del binario de Claude Code: «when you stop before the task is
  ...
  // binario de Claude Code: `ProposeGoal` sale en 13 sitios y en NINGUNO hay
