...
export function presupuestoDeEsfuerzo(
  ...
  // `…` es EL SUELO DE CLAUDE CODE, no invención nuestra. Claude
  // Code trae la misma forma en su tramo de
  // construcción de la petición: `…`
  // (y una segunda vez como `…`
  // con `…`). `1024` ahí es el mínimo LEGAL de la
