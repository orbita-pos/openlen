...
export interface AgentLoopArgs {
  ...
  objetivo?: {
     ...
     *
     * 🔴 LA VARA ES EL BINARIO. Allí el objetivo no es un dato copiado al
...
const READ_ONLY_TOOLS = new Set([
   ...
   *
   * ⚠️ El binario de Claude Code NO decide esto: su bucle principal no lleva
 ...
 *
 * LEÍDO en el binario de Claude Code 2.1.270: su bucle principal NO lleva tope
...
/** Vueltas sin ver la lista antes de devolvérsela. El binario usa 10, con 10 de
...
export async function runAgentLoop(args: AgentLoopArgs): Promise<AgentLoopResult> {
   ...
   *
   * LO QUE HACE EL BINARIO, leído en 2.1.260: cuenta `turnsSinceLastTodoWrite` y
   ...
   * fue qué tarea. El binario puede enseñar estado porque lo mantiene el MODELO
