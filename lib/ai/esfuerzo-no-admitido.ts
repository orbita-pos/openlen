...
//
// EL BINARIO DE CLAUDE CODE NO SE CAE: detecta el rechazo, marca ese modelo con
...
// cadenas que el binario lleva en su propia lista de detección. Y de paso el
 ...
 *
 * Vive en memoria y muere con el proceso, igual que las `requestLatches` del
 * binario. No se persiste a propósito: la capacidad de un modelo puede cambiar
