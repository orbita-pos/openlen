...
## 4 · El binario de Claude Code — releído (2.1.270)
...
2. **Checkpoints y rewind del binario** (punto 4 de la lista del documento). No
...
## 7 · El tope — RESUELTO como lo hace el binario

Jesús: «la opción que sea como Claude Code lo hace en el binario». Leído en
...
### El punto 4 del binario ya lo teníamos
